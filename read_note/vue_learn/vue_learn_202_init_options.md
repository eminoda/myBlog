...
具体 **mergeField** 的 **strats** 策略模式有哪些？

**vue** 对每个 **options** 属性提供了合并策略 **strats**，下面详细了解下：
...
上一篇： [Vue 初始化-初始化开始](./vue_learn_201_init_start.md)

下一篇： [Vue 初始化-渲染代理](./vue_learn_203_init_renderProxy.md)
